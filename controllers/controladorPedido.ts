...
const actualizarPedido = asyncHandler(
  async (req: Request, res: Response): Promise<any> => {
    ...
    cambiarEstadoYAsignarFecha(estado, pedido, res);
...
const cambiarEstadoYAsignarFecha = (estado: any, pedido: any, res: any) => {
  ...
  if (estadosValidos.indexOf(pedido.estado) > estadosValidos.indexOf(estado)) {
    return res
      .status(400)
